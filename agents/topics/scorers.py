...
STYLE_PROMPT = (
    ...
    "Text: {text}\n\n"
    "Style expectations:\n"
    "- 'news summary': concise, third-person, factual, 2–4 sentences\n"
    "- 'opinion': first-person, clear stance with reasoning, 3–5 sentences\n"
    "- 'explainer': educational, plain language, general audience, 3–5 sentences\n"
    "- 'listicle': numbered list, 3–5 items, each a one-sentence explanation\n\n"
